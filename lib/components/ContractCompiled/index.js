...
class ContractCompiled extends React.Component {
    ...
    render() {
        ...
        const { estimatedGas, ContractABI, savePath } = this.state;
        return (
                    ...
                    <Tabs>
                        <TabList>
                            <div className="tab_btns">
                                <Tab>
                                    <div className="btn">ABI</div>
                                </Tab>
                                <Tab>
                                    <button className="btn icon icon-eye inline-block-tight">View</button>
                                </Tab>
                                <Tab>
                                    <button className='btn icon icon-desktop-download inline-block-tight'>Save</button>
                                </Tab>
                            </div>
                        </TabList>
